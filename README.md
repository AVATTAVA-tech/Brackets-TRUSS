...
| :warning: On September 1 of 2021, Adobe ended support for Brackets. If you would like to continue using, maintaining and improving Brackets, you may fork the project on [GitHub](https://github.com/adobe/brackets). TRUSS is an ambitious and futuristic fork of Brackets, which was abandoned by Adobe, regrettably.
| ---
